...
"""
NOTE print("hello, " + name) still works like javascript but arguments part (in python, I'm not sure in javascript) can accept multiple arguments by comma,
#also note that when entering multiple arguments, there is an auto-space between arguments, hence the "hello," part doesn't have a space after the comma. The +
